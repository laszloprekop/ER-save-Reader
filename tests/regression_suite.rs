...
fn test_ground_truth_is_frozen() {
    // Re-pinned 2026-07-20 for the boss_defeats cutover (ADR-0006), which also
    // corrected the stale `pickups` line left behind by f471325. The only
    ...
    const FROZEN_SHA256: &str =
        "3183191486bae687611f132e43f5693fcb8a22386a74c459a35ac8f8345f8b56";
